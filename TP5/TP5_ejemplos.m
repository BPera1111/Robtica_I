...
fprintf('######################################################\n\n')
fprintf('Soluci�n para el ejercicio 4.\n')
fprintf('> Definici�n simb�lica de matriz de par�metros DH\n')
fprintf('> Creaci�n de objeto SerialLink simb�lico\n')
fprintf('> Matrices de DH simb�licas\n')
fprintf('> Cinem�tica Directa simb�lica\n')
fprintf('> Presentaci�n de las 16 ecuaciones\n')
fprintf('> Trabajo algebraico para despeje de inc�gnitas\n')
%=========================================================================%
