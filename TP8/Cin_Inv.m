function [Q,qq] = Cin_Inv(T, R, q_kuka_16, mejor);
    if nargin == 3
        mejor = false;
    elseif nargin ~= 4
    ...
    T = invHomog(double(R.base)) * double(T) * invHomog(double(R.tool));
    ...
    for i=1:2:7
        ...
        q2 = qq(2, i);
        q3 = qq(3, i);
        [q4, q5, q6] = calcular_qm(R, q1, q2, q3, T, q_kuka_16);
...
%=========================================================================%
% Funcion para cálculo de q4,q5,q6
